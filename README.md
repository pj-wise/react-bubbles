...
- [ ] Explain what a token is used for.
      authentication usually. Typically once logged in a token is set in localStorage as a representation that you are allowed access to the site. Tokens can also be used for other things such as interaction tracking and unique identifier.
- [ ] What steps can you take in your web apps to keep your data secure?
      authentication and salting.
- [ ] Describe how web servers work.
      a server will receive a request from the client and in turn an action takes place. CRUD.
